...
public class MagicTextView extends AppCompatTextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            if(a.hasValue(R.styleable.MagicTextView_background_color)){
                Drawable background = a.getDrawable(R.styleable.MagicTextView_background_color);
                if(background != null){
                    this.setBackgroundDrawable(background);
                }else{
                    this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_background_color, 0xff000000));
                }
            }
