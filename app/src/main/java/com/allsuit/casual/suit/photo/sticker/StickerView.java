...
public class StickerView extends FrameLayout {
 ...
 /* BitmapStickerIcon swapIcon = new BitmapStickerIcon(
            ContextCompat.getDrawable(getContext(), R.drawable.icon_sticker_top_enable),
            BitmapStickerIcon.LEFT_BOTTOM);
    swapIcon.setIconEvent(new BringToFrontIconEvent());*/
